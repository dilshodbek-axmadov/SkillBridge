    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <p className="text-lg sm:text-xl text-primary-100 max-w-2xl mx-auto mb-10 leading-relaxed">
          Make data-driven career decisions with real market insights from Uzbekistan.
          Discover your skills, find your path, and land your dream job.
        </p>
