  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 py-4">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {profile.experience_level && (
              <div className="flex items-center gap-2 bg-gray-100 text-gray-600 px-3 py-1.5 rounded-lg text-sm font-medium capitalize">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-medium text-amber-800">Before we begin</p>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 px-6 py-3.5 bg-primary-600 text-white rounded-xl text-sm font-semibold border-none cursor-pointer hover:bg-primary-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed shadow-sm"
        >
        ...
        <Link
          to="/manage-skills"
          className="flex-1 flex items-center justify-center gap-2 px-6 py-3.5 border border-gray-300 text-gray-600 rounded-xl text-sm font-semibold no-underline hover:bg-gray-50 transition-colors text-center"
        >
            ...
            return (
              <div
                ...
                className={`flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all duration-500 ${
                  isActive
                    ? 'bg-white shadow-sm border border-gray-200 scale-[1.02]'
                    : isDone
                      ? 'opacity-50'
                      : 'opacity-30'
                }`}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <button
          onClick={onReanalyze}
          className="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-200 text-gray-700 rounded-xl text-sm font-medium cursor-pointer hover:bg-gray-50 transition-colors"
        >
  ...
  return (
    <div className="relative">
      <select
        ...
        className="appearance-none bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 pr-8 text-sm text-gray-700 font-medium cursor-pointer hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
      >
        {options.map((o) => (
    ...
    <div className={`bg-white rounded-xl border border-gray-200 border-l-4 ${pri.border} p-5 hover:shadow-md transition-shadow`}>
      <div className="flex flex-col sm:flex-row sm:items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {gap.reason && (
            <p className="text-sm text-gray-600 leading-relaxed mb-3">{gap.reason}</p>
          )}
        ...
        <div className="flex sm:flex-col gap-2 flex-shrink-0">
          {gap.status === 'pending' && (
            <>
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-2 bg-gray-100 text-gray-500 rounded-lg text-xs font-semibold border-none cursor-pointer hover:bg-gray-200 transition-colors"
              >
          ...
          {gap.status === 'skipped' && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2 bg-gray-100 text-gray-600 rounded-lg text-xs font-semibold border-none cursor-pointer hover:bg-gray-200 transition-colors"
            >
          ...
          {gap.status === 'completed' && (
            <span className="inline-flex items-center gap-1.5 px-3 py-2 bg-emerald-50 text-emerald-600 rounded-lg text-xs font-semibold">
              <CheckCircle2 className="w-3 h-3" />
              Done
            </span>
          )}
