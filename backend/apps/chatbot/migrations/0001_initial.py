...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("onboarding", "Onboarding / Career Assessment"),
                            ("roadmap", "Learning Roadmap"),
                            ("career", "Career Advice"),
                            ("help", "General Help"),
                        ],
                        help_text="Type of conversation/assistance",
                        max_length=20,
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="When conversation was closed/completed",
                        null=True,
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Is this conversation still ongoing?",
                        verbose_name="active",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "message_text",
                    models.TextField(
                        help_text="Message content", verbose_name="message text"
                    ),
                ),
                (
                    "context_data",
                    models.JSONField(
                        blank=True,
                        help_text="Additional context like skills, roles, intent, etc.",
                        null=True,
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "is_active"], name="chatbot_con_user_id_3141f9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="chatbotconversation",
            index=models.Index(
                fields=["-started_at"], name="chatbot_con_started_51736b_idx"
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="chatbot_mes_convers_90de13_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="chatbotmessage",
            index=models.Index(
                fields=["sender_type"], name="chatbot_mes_sender__4e061d_idx"
            ),
        ),
    ]
