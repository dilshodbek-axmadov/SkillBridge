...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Author or creator name.",
                        max_length=200,
                        null=True,
                        verbose_name="author",
                    ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Platform (YouTube, Udemy, W3Schools, etc.).",
                        max_length=100,
                        null=True,
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Whether resource is free or paid.",
                ...
                (
                    ...
                    models.CharField(
                        default="en",
                        help_text="Content language (en/ru/uz).",
                        max_length=10,
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Whether resource has been manually verified.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text='Roadmap title (e.g., "Path to Backend Developer").',
                        max_length=200,
                        verbose_name="title",
                    ),
                ),
                (
                    "target_role",
                    models.CharField(
                        help_text="Target career role for this roadmap.",
                        max_length=200,
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="AI-generated roadmap description and overview.",
                        null=True,
                        verbose_name="description",
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Total estimated learning hours for entire roadmap.",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Whether this roadmap is currently active.",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Whether roadmap was AI-generated or manually created.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sequence_order",
                    models.IntegerField(
                        help_text="Order of this item in the roadmap (1, 2, 3...).",
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Estimated hours to complete this skill.",
                        verbose_name="estimated duration (hours)",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        default="medium",
                        help_text="Learning priority for this item.",
                        max_length=20,
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="pending",
                        help_text="Current learning status.",
                        max_length=20,
                        verbose_name="status",
                    ),
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="AI-generated notes or learning tips for this skill.",
                        null=True,
                        verbose_name="notes",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="User notes and observations.",
                        null=True,
                        verbose_name="notes",
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="User rating for this resource (1-5).",
                        null=True,
        ...
        migrations.AddIndex(
            model_name="learningresource",
            index=models.Index(
                fields=["resource_type"], name="learning_re_resourc_f4a5a4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="learningresource",
            index=models.Index(
                fields=["difficulty_level"], name="learning_re_difficu_cbb08e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="learningresource",
            index=models.Index(
                fields=["is_free"], name="learning_re_is_free_aadc3d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="learningroadmap",
            index=models.Index(
                fields=["user", "is_active"], name="learning_ro_user_id_35c9e9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="learningroadmap",
            index=models.Index(
                fields=["target_role"], name="learning_ro_target__7b6cc4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="roadmapitem",
            index=models.Index(
                fields=["roadmap", "sequence_order"],
                name="roadmap_ite_roadmap_667e5a_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="roadmapitem",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "status"], name="user_learni_user_id_ce7e2b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="userlearningprogress",
            index=models.Index(
                fields=["resource"], name="user_learni_resourc_35e0da_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="userlearningprogress",
